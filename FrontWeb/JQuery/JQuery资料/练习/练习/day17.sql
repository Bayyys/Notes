...
-- 表中添加数据
INSERT INTO USER VALUES(NULL,'zhangsan','1234','张三');
INSERT INTO USER VALUES(NULL,'lisi','5678','李四');
INSERT INTO USER VALUES(NULL,'wangwu','1234','王五');
...
INSERT  INTO `category`(`cid`,`cname`) VALUES ('1','手机数码'),('2','电脑办公'),('3','家具家居'),('4','鞋靴箱包'),('5','图书音像'),('6','母婴孕婴'),('7','运动户外'),('8','aaaa'),('9','汽车用品');
