...
![image-20210804133448677](https://s2.loli.net/2023/07/24/EdhgiqFUlOwMoKQ.png)
...
![image-20210804144730761](https://s2.loli.net/2023/07/24/AKtsXLDqaBjzbyO.png)
...
![image-20210804145401521](https://s2.loli.net/2023/07/24/6WVMXS3y1NcU7GI.png)
...
![image-20210804145526933](https://s2.loli.net/2023/07/24/QqnkUIF4mA7S3Mh.png)

## 2.1 多个参数

函数可以有多个参数。在调用函数时，只需使用逗号将这些参数分开即可。

![image-20210804150422862](https://s2.loli.net/2023/07/24/cW1oNAvtPelwQq3.png)
...
![image-20210804152348446](https://s2.loli.net/2023/07/24/7qnrlwmd4I5XjCL.png)
...
![image-20210804154353723](https://s2.loli.net/2023/07/24/bn8GUdqaX3e2tRD.png)
...
![image-20210804171314723](https://s2.loli.net/2023/07/24/B3q8yVva4erDLjO.png)

这里要求 `pt` 指向的是一个 `const int`，所以，赋值之后我们是不能用 `*pt` 来修改 age 的值的。

![image-20210804171334907](https://s2.loli.net/2023/07/24/yvzewY7gSiN6m3L.png)

现在来看一个微妙的问题。pt的声明并不限定着它指向的值就必须得是一个常量，只是对pt来说，这个值是常量。例如，pt指向age，但age不是const。我们是可以直接通过 age 变量来修改 age 的值的，但不能使用 pt 指针来修改它。

![image-20210804171429933](https://s2.loli.net/2023/07/24/7xmLSYsnBwUKvGO.png)

> 我觉得这类指针可以称为：**只读指针**。这个指针可以移动，但是它只能读出它所指向地址的内容，但是无法通过这个指针修改其中的数据。

![image-20210804171526205](https://s2.loli.net/2023/07/24/IuDGZcBTERhlQga.png)
...
![image-20210804172525799](https://s2.loli.net/2023/07/24/FEmx8iR7PpuzTwf.png)
...
![image-20210804204604444](https://s2.loli.net/2023/07/24/HGfBRnkOXecmvVS.png)
...
![image-20210804214230755](https://s2.loli.net/2023/07/24/RSg4Ws5lx1ynNLb.png)
...
![image-20210805084458826](https://s2.loli.net/2023/07/24/68nVjs9FETfd1cD.png)

3．使用指针来调用函数

![image-20210805084920592](https://s2.loli.net/2023/07/24/Sq3IxEbK9HJfYuQ.png)
